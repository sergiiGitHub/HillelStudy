package com.study.springboot.configurtion;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.study.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.study.springboot.model" });
